...
class SupervisedWebDataset(IterableDataset):
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer, data_args: DataArguments):
        ...
        import webdataset as wds
        self.dataset = wds.WebDataset(f"{data_path}", nodesplitter=wds.split_by_node, resampled=True, repeat=True).shuffle(1000)
    ...
    def _get_item(self, sources) -> Dict[str, torch.Tensor]:
        ...
        print(f'_get_item {current_time.strftime("%Y-%m-%d %H:%M:%S")} id={sources["id"]}', flush=True)
