...
class TrainingArguments(transformers.Seq2SeqTrainingArguments):
    ...
    output_dir: str = field(default='./output_qlora_calora', metadata={"help": 'The output dir for logs and checkpoints'})
...
class SavePeftModelCallback(transformers.TrainerCallback):
    def save_model(self, args, state, kwargs):
        ...
        ckpt = kwargs["model"].state_dict()
        torch.save(ckpt, os.path.join(peft_model_path, "lora.pt") )
...
def get_accelerate_model(args, checkpoint_dir):
    ...
    ckpt = torch.load('/cdgm0705/hyx/alpaca-lora/adapter_model.pt')
...
def train():
    ...
    model, tokenizer, base_model = get_accelerate_model(args, checkpoint_dir)
