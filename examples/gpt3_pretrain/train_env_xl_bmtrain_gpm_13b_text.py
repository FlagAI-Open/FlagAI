...
env_args = EnvArgs(
    ...
    save_dir="checkpoints_gpm_13b_text",
...
# TODO
data_path = '/share/project/ldwang/data/text/gpm/split'
...
def read_file_dev():
    ...
    if enable_debug:
        ...
        part_file = '%s/3000.txt' % data_path
    if True:
        filename = part_file
        # print('*'*20, "filename", filename)
        with open(filename, 'r', encoding='utf-8') as f:
