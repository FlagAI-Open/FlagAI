...
if __name__ == '__main__':
    ...
    valid_path = '/mnt/datasets/t5_triple2ques_data/dev.json'
    model_name = 'T5'
    batch_size = 64
    ...
    valid_data = train_data_process_kgclue_cgrm_seq2seq(valid_path)
    ...
    valid_dataset = DataSet(valid_data[["seq1",
                                        "seq2"]], tokenizer, max_length_source,
                            max_length_target, "seq1", "seq2")
    ...
    validate(tokenizer, model, valid_dataloader, max_length_target)
