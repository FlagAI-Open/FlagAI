...
class GPTModel(GPTPreTrainedModel):
    ...
    def bmt_replace(self):
        ...
        self.layers = bmt.TransformerBlockList(blocks, num_hidden=2)
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None):
        ...
        # print(f"XXX forward: bmt={self.bmt}, prenorm={self.prenorm}, parallel_block={self.parallel_block}", flush=True)
        if self.bmt:
            if self.prenorm:
                if residual is None:
