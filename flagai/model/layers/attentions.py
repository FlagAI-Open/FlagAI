...
from flagai.model.layers.layer_norm import CPM3LayerNorm, CPM3bmtLayerNorm
...
class CPM3bmtAttention(bmt.DistributedModule):
    ...
    def __init__(self, dim_in : int, 
        ...
        super().__init__()
        print('attention params', dim_in, dim_head, num_heads, dim_out, dtype, int8, init_mean, init_std, bias, mask_value, pos_bias_type, length_scale, attn_scale, dropout_p)
        if dim_out is None:
            dim_out = dim_in
